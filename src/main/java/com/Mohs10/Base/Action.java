...
public class Action extends StartBrowser {
	...
	public void clear(By locator, String eleName) throws Exception {
	    try {
	        ...
	        StartBrowser.childTest.pass("Performed clear action on: " + eleName);
	    } catch (Exception e) {
	        StartBrowser.childTest.fail("Unable to perform clear action on: " + eleName,
	                MediaEntityBuilder.createScreenCaptureFromBase64String(captureScreenshot(eleName)).build());
	        StartBrowser.childTest.info(e);
	        throw e;
	    }
	...
	// Method to capture a screenshot and save it to the specified location
